...
function get_xyz(){
        var h = '/xdnphb/main/v1/weibo_day/rank?AppKey=joker&end=2022-09-04&rank_name=个人认证&rank_name_group=&start=2022-09-04';
        var i = get_nonce();
        mid = "&nonce=" + i;
        var data = h + mid
    console.log(data);
...
console.log(b("/xdnphb/main/v1/weibo_day/rank?AppKey=joker&end=2022-09-04&rank_name=个人认证&rank_name_group=&start=2022-09-04&nonce=69525f8c7"));